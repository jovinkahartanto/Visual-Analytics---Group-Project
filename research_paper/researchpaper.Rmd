...
Our research and development effort was motivated by the general lack of effective and easy to use web-enabled data visualisation tool to conduct data analysis on the GAStech employees related dataset. The project aims to enable the Kronos law enforcement the ability to easily analyse, drill down and identify key suspects and suspicious locations, and thereby speeding up the investigation process. 
...
The authors wish to thank Professor Kam Tin Seong of Singapore Management University for his support and guidanec throughout this project.
