---
title: STAGEMD - SaptioTemporal Analysis of Gastech Employees' Movement Data
author:
  - name: Chen Yuxi
...
The dataset was wrangled to develop a Shiny app, STAGEMD, that aims to provide users actionable insights based on the following analyses:
...
# Design framework 
The STAGEMD application was built with several functionalities. 
...
Network is a graphical representation of the relationships (edges) between variables (nodes). It provides the capacity to estimate complex patterns of relationships and the network structure can be analysed to reveal core features of the network.
(David Hevey (2018) Network analysis: a brief overview and tutorial, Health Psychology and Behavioral Medicine, 6:1, 301-328, DOI: 10.1080/21642850.2018.1521283)
