...
[link]https://www.sciencedaily.com/releases/2014/09/140916102000.htm
...
```{r mc3, fig.align = 'center', fig.cap = 'Project Gantt Chart', echo=FALSE}
...
## Data Visualisation
* Cloropleth maps to identify popular location 
* Geospatial maps to show the maps of Abila
* Histogram to show frequency of visit to specific locations based off GPS data
* Parallel plot to show potential informal or unofficial relationships among GASTech personnel
* Boxplot for transaction data from credit card and loyalty card
* Line graph to show speed of the vehicles of the respective employee
* Visualize movement and temporal changes of the GPS tracking data by creating video animations
...
* Multiple values (drop down) of employees to display moving line from GPS data on Abila map
* Slide bar for time and date inputs for cloropleth maps
