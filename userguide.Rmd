...
Text to be input thereafter

## 3.0 Locations Transactions

### 3.1 Filter selection Panel
The tab analyse the credit card and loyalty card transactions to determine the most popular locations.
...
Figure \@ref(fig:location-gif) shows selection of all choices from the *Location* and *Employee* filters, *Date* range of 12 to 19 January during the evening to night *Time Period* for employee in the *Security* department only. Clicking on the **Submit** button will update the visualisation accordingly to the filter selections.
