...
Figure \@ref(fig:map-gif) shows selection of employee *Onda Marin* on 6 January 2014. The map on the right panel dynamically changed after the **Submit** button is clicked. User can hover around the stop locations represented by blue dots and click to display micro data of the car owner name, time when car is stationary and its possible location.
