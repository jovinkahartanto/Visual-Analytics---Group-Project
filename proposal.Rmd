...
* Slide bar for time and date inputs for 
...
```{r, fig.align = 'center', fig.cap = 'Dashboard Interface 3', echo=FALSE}
knitr::include_graphics("img/dashboard3.gif")
```

```{r, fig.align = 'center', fig.cap = 'Dashboard Interface 4', echo=FALSE}
